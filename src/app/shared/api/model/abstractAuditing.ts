...
/**
 * Non functional information related to all objects from the API.
 */
export interface AbstractAuditing { 
    ...
    /**
     * Unique identifier of the user initiating the creation.
     */
    ...
    /**
     * Unique identifier of the user initiating the last modification.
     */
