...
/**
 * Type of the alert:  1. `medical`: Medical alert type 2. `sos` : SOS alert type 3. `threat`: Threat alert type 4. `flic` : Flic alert type 5. `fall_detected`: Fall detected alert type 6. `verticality_loss` : Verticality loss alert type 7. `no_network_session_expired`: No network session expired alert type 8. `test`: Test alert type
 */
export type AlertType = 'medical' | 'sos' | 'threat' | 'flic' | 'fall_detected' | 'verticality_loss' | 'no_network_session_expired' | 'test';

export const AlertType = {
    Medical: 'medical' as AlertType,
    Sos: 'sos' as AlertType,
    Threat: 'threat' as AlertType,
    Flic: 'flic' as AlertType,
    FallDetected: 'fall_detected' as AlertType,
    VerticalityLoss: 'verticality_loss' as AlertType,
    NoNetworkSessionExpired: 'no_network_session_expired' as AlertType,
    Test: 'test' as AlertType
};
